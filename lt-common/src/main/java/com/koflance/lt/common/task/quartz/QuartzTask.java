...
import com.koflance.lt.common.Asserts;
import com.koflance.lt.common.task.Task;
import com.koflance.lt.common.task.simple.DefaultTask;
...
public abstract class QuartzTask extends DefaultTask {
    ...
    public void start() {
        ...
        com.koflance.lt.common.task.quartz.SchedulerFactory schedulerFactory = new com.koflance.lt.common.task.quartz.SchedulerFactory(this);
        // 创建一个新的scheduler
